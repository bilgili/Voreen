...
std::string voreen::DicomMoveSCU::ourtitle_ = "";
int voreen::DicomMoveSCU::retrievePort_ = -1;
std::string voreen::DicomMoveSCU::peer_ = "";
int voreen::DicomMoveSCU::port_ = -1;
int voreen::DicomMoveSCU::filesDone_ = 0;
voreen::DicomSecurityOptions voreen::DicomMoveSCU::security_ = voreen::DicomSecurityOptions();
...
voreen::DicomMoveSCU::QueryModel        opt_queryModel = voreen::DicomMoveSCU::QMPatientRoot;
string            filePath = "";
        ...
        if ((rsp->DimseStatus == STATUS_Success)&&(!opt_ignore))
        {
          ...
          else
          {
              if (filelist != 0) {
                  ...
                  voreen::DicomMoveSCU::filesDone_++;
                  printf("Done: %i\n", voreen::DicomMoveSCU::filesDone_);
              }
          }
        }
...
bool voreen::DicomMoveSCU::init(const std::string& ourtitle, int retrievePort,
...
int voreen::DicomMoveSCU::move(std::vector<std::string>& keys, QueryModel queryModel,
...
int voreen::DicomMoveSCU::moveSeries(const std::string& seriesInstanceUID, const std::string& peerTitle,
...
void voreen::DicomMoveSCU::cancelMove() {
