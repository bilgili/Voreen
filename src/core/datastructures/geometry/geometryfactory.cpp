...
GeometryFactory::GeometryFactory() {
    registerType(new VertexGeometry());
    registerType(new FaceGeometry());
    registerType(new MeshGeometry());
    registerType(new MeshListGeometry());
    registerType(new PointListGeometryVec3());
    registerType(new PointSegmentListGeometryVec3());
}
