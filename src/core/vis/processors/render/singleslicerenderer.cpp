...
#ifndef VRN_SINGLESLICERENDERER_H
    ...
    : SliceSequenceRenderer(true)
{
    ...
    numSlicesPerRowProp_.set(1);

    numSlicesPerColProp_.setMinValue(1);
    numSlicesPerColProp_.setMaxValue(1);
...
const std::string SingleSliceRenderer::getProcessorInfo() const {
    return "Performs rendering of a single slice parallel to the front, side or top of a dataset.";
}
