      ...
      outport4_(Port::OUTPORT, "image.outport4")
{
    ...
    scalingMode1_.selectByKey("keep-ratio-all");
    ...
    scalingMode2_.selectByKey("keep-ratio-all");
    ...
    scalingMode3_.selectByKey("keep-ratio-all");
    ...
    scalingMode4_.selectByKey("keep-ratio-all");
...
const std::string MultiScale::getProcessorInfo() const {
