...
void TripleView::portResized(RenderPort* /*p*/, tgt::ivec2 newsize) {
...
void TripleView::updateSizes() {
    ...
    if(maximized_.get() == 0) {
        tgt::ivec2 subsize = outport_.getSize();
        subsize.x /= 3;
...
void TripleView::sizeOriginChanged(RenderPort* /*p*/) {
}

bool TripleView::testSizeOrigin(const RenderPort* p, void* so) const {
