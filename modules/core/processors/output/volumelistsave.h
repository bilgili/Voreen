...
protected:
    virtual void setDescriptions() {
        setDescription("Saves the input volume list to a user-selected directory. The volumes will be saved as .vvd files with the specified basename. If no basename is given, the volumes' filenames are used.");
    }
