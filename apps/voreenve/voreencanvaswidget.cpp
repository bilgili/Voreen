...
VoreenCanvasWidget::VoreenCanvasWidget(QWidget* parent, VoreenCanvasWidget::CameraNavigation navigation)
...
VoreenCanvasWidget::~VoreenCanvasWidget() {
    delete trackNavi_;
    delete flythroughNavi_;
    delete painter_;
}

TrackballNavigation* VoreenCanvasWidget::getTrackballNavigation() const {
    return trackNavi_;
}

FlythroughNavigation* VoreenCanvasWidget::getFlythroughNavigation() const {
    return flythroughNavi_;
}

void VoreenCanvasWidget::setCurrentNavigation(VoreenCanvasWidget::CameraNavigation navi) {
...
VoreenCanvasWidget::CameraNavigation VoreenCanvasWidget::getCurrentNavigation() const {
    return currentNavigation_;
}

void VoreenCanvasWidget::init(NetworkEvaluator* eval, tgt::Camera* camera) {
    evaluator_ = eval;
    camera_ = camera;
...
void VoreenCanvasWidget::initializeGL() {
