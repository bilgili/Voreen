...
#ifndef VRN_CANVASWIDGET_H
#define VRN_CANVASWIDGET_H
...
class VoreenCanvasWidget : public tgt::QtCanvas {
    Q_OBJECT
public:
    ...
    VoreenCanvasWidget(QWidget* parent = 0, CameraNavigation navigation = TRACKBALL_NAVIGATION);
    ~VoreenCanvasWidget();
