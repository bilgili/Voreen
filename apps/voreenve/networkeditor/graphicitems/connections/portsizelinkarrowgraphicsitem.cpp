...
#include "portsizelinkarrowgraphicsitem.h"
    ...
    , clickedPoint_(), arrowDraged_(false), dragedArrowMoved_(false), currentArrowInitialized_(false)
{
    ...
    destinationArrowHeadDirection_ = ArrowHeadDirectionNS;
...
void PortSizeLinkArrowGraphicsItem::prePaint(QPainter* painter, const QStyleOptionGraphicsItem* option) {}

void PortSizeLinkArrowGraphicsItem::mainPaint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget) {
    currentStyle()->PortSizeLinkArrowGI_paint(this, painter, option, widget);
}
