    ...
    for (size_t i = 0; i < propertyList_.size(); i++){
        switch (propertyList_.at(i)->getType()){
            ...
            case Property::FLOAT_PROP:
                ...
                if ( abs(prop->get() - spin->value() ) > epsilon_){
                    prop->set(spin->value());
            ...
            case Property::FLOAT_VEC2_PROP:
                ...
                if( ( abs(prop->get().x - sp1->value()) > epsilon_) || ( abs(prop->get().y - sp2->value()) > epsilon_))
                {
            ...
            case Property::FLOAT_VEC3_PROP:
                ...
                if( ( abs(prop->get().x - sp1->value()) > epsilon_) || ( abs(prop->get().y - sp2->value()) > epsilon_)||( abs(prop->get().z - sp3->value()) > epsilon_))
                {
            ...
            case Property::FLOAT_VEC4_PROP:
                ...
                if( ( abs(prop->get().x - sp1->value()) > epsilon_) || ( abs(prop->get().y - sp2->value()) > epsilon_)||( abs(prop->get().z - sp3->value()) > epsilon_)
                   || ( abs(prop->get().w - sp4->value()) > epsilon_))
                {
            ...
            case Property::COLOR_PROP:
                ...
                if( ( abs(prop->get().r - color.r) > epsilon_) || ( abs(prop->get().g - color.g) > epsilon_)||( abs(prop->get().b - color.b) > epsilon_)
                   || ( abs(prop->get().a - color.a) > epsilon_))
                {
                      prop->set(color);
    ...
    , curColor_(color)
{
    ...
    newPalette.setColor(QPalette::Window, QColor(color.r * 255,color.g * 255,color.b * 255,color.a * 255));
