...
#ifndef VRN_ROISUBSTRACT_H
#define VRN_ROISUBSTRACT_H

#include "roiaggregation.h"

namespace voreen {

class ROISubstract : public ROIAggregation {
public:
    ROISubstract(Grid grid);
    ROISubstract() : ROIAggregation() {}
    virtual std::string getClassName() const { return "ROISubstract"; }
    virtual ROIBase* create() const { return new ROISubstract(); }
