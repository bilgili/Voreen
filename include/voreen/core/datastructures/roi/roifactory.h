...
#ifndef VRN_ROIFACTORY_H
#define VRN_ROIFACTORY_H
...
class VRN_CORE_API ROIFactory : public ResourceFactory<ROIBase> {
public:
    /// Returns a new instance of the class corresponding to the given typeString.
    virtual ROIBase* createROI(const std::string& typeString);
};
