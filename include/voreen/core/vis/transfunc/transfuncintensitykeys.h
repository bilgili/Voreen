 ...
 */
class TransFuncIntensityKeys : public TransFuncIntensity {
public:
     ...
     */
    TransFuncIntensityKeys(int width = 256);

    /** Copy constructor.
     * Warning: Needs opengl context!
     * \param tf The adress of the TransFuncIntensityKeys instance, which is to be copied.
     */
    TransFuncIntensityKeys(const TransFuncIntensityKeys& tf);
    
    virtual ~TransFuncIntensityKeys();
...
protected:
    ...
    */
    ...
    /**
     * \sa TransFuncIntensityKeys::readInt(std::ifstream& stream)
     */
