...
#ifndef VRN_COMPACTOPTIONPROPERTYWIDGET_H
#define VRN_COMPACTOPTIONPROPERTYWIDGET_H
...
class CompactOptionPropertyWidget : public CompactPropertyWidget {
Q_OBJECT
public:
    CompactOptionPropertyWidget(OptionPropertyBase* prop, QWidget* parent = 0);
