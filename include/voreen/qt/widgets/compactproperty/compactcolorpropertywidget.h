...
#ifndef VRN_COMPACTCOLORPROPERTYWIDGET_H
#define VRN_COMPACTCOLORPROPERTYWIDGET_H
...
class CompactColorPropertyWidget : public CompactPropertyWidget {
    Q_OBJECT
public:
    CompactColorPropertyWidget(ColorProp* prop, QWidget* parent = 0);
...
#endif // VRN_COMPACTCOLORPROPERTYWIDGET_H
