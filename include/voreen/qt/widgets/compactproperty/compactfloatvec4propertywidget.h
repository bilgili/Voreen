...
#ifndef VRN_COMPACTFLOATVEC4PROPERTYWIDGET_H
#define VRN_COMPACTFLOATVEC4PROPERTYWIDGET_H
...
class CompactFloatVec4PropertyWidget : public CompactPropertyWidget {
Q_OBJECT
public:
    CompactFloatVec4PropertyWidget(FloatVec4Prop* prop, QWidget* parent = 0);
    void update();
...
public slots:
    ...
    void setPropertyW(double w);

protected:
    FloatVec4Prop* property_;
